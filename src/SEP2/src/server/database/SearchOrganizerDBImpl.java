    ...
    public ArrayList<Organizer> searchOrganizerByRegion(String region) {
        try(Connection connection = DataBaseAccess.getInstance().getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(
                "SELECT o.fullName fullName, u.city city, o.organizerUserId userId "
                    + "FROM users u, organizers o, cities c, regions r "
                    + "WHERE u.id = o.organizerUserId AND u.city = c.cityName AND c.regionId = r.regionId AND r.regionName = ?"))
        {
